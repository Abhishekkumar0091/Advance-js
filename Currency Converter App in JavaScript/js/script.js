...
function getExchangeRate(){
    ...
    let url = `https://v6.exchangerate-api.com/v6/946b03ffc532fdc311ef4f7f/latest/${fromCurrency.value}`;
   //let url =`https://v6.exchangerate-api.com/v6/d8b732971f7e3c2909a47697/latest/USD/${fromCurrency.value}`
